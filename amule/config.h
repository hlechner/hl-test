...
/* Define this variable to 1 if using mapped memory was requested. Note that
   defining it will alone not allow usage of mmap(), but unsetting it will
   completely disable its usage. */
/* #undef ENABLE_MMAP */
...
/* Define to 1 if you have the <execinfo.h> header which declares backtrace()
   */
...
/* Define to 1 if you have posix_fallocate() and it should be used. */
...
/* Define to 1 if you have the _SC_PAGESIZE constant in <unistd.h> */
/* #undef HAVE__SC_PAGESIZE */

/* Define to 1 if you have the _SC_PAGE_SIZE constant in <unistd.h>, but not
   _SC_PAGESIZE */
/* #undef HAVE__SC_PAGE_SIZE */
